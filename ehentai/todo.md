- look into tag suggest api, may be i can use it to check valid tags instead of guessing; there is also script by terry which uses it i think
- migrate here other scripts; split tightly coupled bundles (may be)
